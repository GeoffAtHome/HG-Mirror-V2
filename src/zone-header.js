    ...
    static get template() {
        ...
        <style include="iron-flex iron-flex-alignment shared-styles">
            :host {
                ...
                box-shadow: 0 0 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0
        ...
        <div class="layout horizontal justified top">
            <div class="layout horizontal layout-start">
                ...
                <a href="/boost/[[zone.iID]]">
                    <paper-icon-button class\$="[[isBoost(zone)]]" title="Boost"
                     icon="my-icons:boost"></paper-icon-button>
                </a>
                <a href="/home/[[zone.iID]]/timer">
                    <paper-icon-button class\$="[[isTimer(zone)]]" title="Timer"
                     icon="my-icons:timer"></paper-icon-button>
                </a>
                <template is="dom-if" if="[[isNotSwitch(zone)]]">
                    <a href="/home/[[zone.iID]]/footprint">
                        <paper-icon-button class\$="[[isFootprint(zone)]]" title="Footprint"
                         icon="my-icons:footprint"></paper-icon-button>
                    </a>
                </template>
            </div>
